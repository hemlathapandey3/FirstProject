...
<div style="background-image:url('images/inner-banner.jpg'); id="home">
<div class="container">
	<div class="logo">
		<h1><a class="cd-logo link link--takiri fadeInDown animated" href="index.html"><br/>SpecialVivah<span><i class="fa fa-heart" aria-hidden="true"></i>Come Find Love.</span></a></h1>
	</div>
	<div class="clearfix" ></div>
	<div class="agileits-register wow bounceInUp animated" data-wow-delay="0.5s">
		<h3>Register NOW!</h3>
		<form action="Register" method="post" class="form wow fadeIn animated" data-wow-delay="1s">
				...
				<div class="w3_modal_body_grid w3_modal_body_grid1 wow fadeIn animated" data-wow-delay="1.2s">
					<span>Name:</span>
					<input type="text" name="name" placeholder=" " required=""/>
				</div>
				<div class="w3_modal_body_grid wow fadeIn animated" data-wow-delay="1.4s">
					<span>Gender:</span>
					<div class="w3_gender">
						<div class="colr ert">
				...
				<div class="w3_modal_body_grid w3_modal_body_grid1 wow fadeIn animated" data-wow-delay="1.6s">
				...
				<div class="w3_modal_body_grid wow fadeIn animated" data-wow-delay="1.8s">
					<span>religion:</span>
				...
				<div class="w3_modal_body_grid w3_modal_body_grid1 wow fadeIn animated" data-wow-delay="2s">
				<span>Mobile No:</span>
				...
				<div class="w3_modal_body_grid wow fadeIn animated" data-wow-delay="2.2s">
					<span>Email:</span>
					<input type="email" name="email" placeholder=" " required=""/>
				</div>
				<div class="w3_modal_body_grid w3_modal_body_grid1 wow fadeIn animated" data-wow-delay="2.4s">
					<span>Password:</span>
					<input type="password" name="password" placeholder=" " required=""/>
				</div>
				<div class="w3-agree wow fadeIn animated" data-wow-delay="2.6s">
					...
					<div class="modal-content">
					  ...
					  <div class="modal-body">
						<div class="login-w3ls">
							...
							String log = (String)session.getAttribute("logincheck");
							if(log.equals("false"))
									{
								out.println("<label>Wrong Username or Password</label>");
									}
...
<!-- Find your soulmate -->
	<div class="w3l_find-soulmate text-center zoomIn animated" >
		<h3>Find Your Soulmate</h3>
			<div class="container">
				<a class="scroll " href="#home">
					<div class="col-md-3 w3_soulgrid wow fadeInLeft animated" data-wow-delay="0.5s">
				...
				<a class="scroll"  href="#home">
					<div class="col-md-3 w3_soulgrid wow fadeInLeft animated" data-wow-delay="0.1s">
				...
				<a class="scroll" href="#home">
					<div class="col-md-3 w3_soulgrid wow fadeInRight animated" data-wow-delay="0.1s">
				...
				<a class="scroll" href="#home">
					<div class="col-md-3 w3_soulgrid wow fadeInRight animated" data-wow-delay="0.5s">
			...
			<div class="w3layouts_featured-profiles">
				...
				<div class="agile_featured-profiles">
					<h2>Featured Profiles</h2>
							<ul id="flexiselDemo3">
								<li>
									<div class="col-md-3 biseller-column wow jackInTheBox animated" data-wow-delay="0.5s">
										<a href="groom_profile.html">
											<div class="profile-image wow jackInTheBox animated" data-wow-delay="0.5s">
									...
									<div class="col-md-3 biseller-column wow jackInTheBox animated" data-wow-delay="0.7s">
										<a href="bride_profile.html">
											<div class="profile-image">
