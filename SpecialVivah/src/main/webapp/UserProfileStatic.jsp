...
%>  
	...
	if(session.getAttribute("UserProfileStatic")!= null)
	{
String profileStatic =(String)session.getAttribute("UserProfileStatic");
						
								if(profileStatic.equals("false"))
							{
								response.sendRedirect("Login.jsp");
							}
}
									UserDetailEntity staticDetails =(UserDetailEntity)session.getAttribute("UserDetailStatic");
			...
			<div class="profile_w3layouts_details">
				...
				<form action="/profile" method="post">
					...
					<div class="form_but1">
						...
						<div class="col-sm-9 w3_details">
						<%= staticDetails.annual_income %>						</div>
						<div class="clearfix"> </div>
					</div>
					<h5>Lifestyle:</h5>
					<div class="form_but1">
					...
					<div class="form_but1">
						...
						<div class="col-sm-9 w3_details">
						<%= staticDetails.education %>						</div>
						<div class="clearfix"> </div>
					</div>
					<div class="form_but1">
						<label class="col-sm-3 control-label1" for="Relation">Occupation : </label>
						<div class="col-sm-9 w3_details">
						<%= staticDetails.occupation1 %>
						</div>
						<div class="clearfix"> </div>
					</div>
					<div class="form_but1">
